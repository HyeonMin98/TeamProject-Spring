...
public class Ade1 extends Panel {

	Ade1 a1 = this;

	public Ade1(Frame f, List list) {
		...
		ade.setBackground(Color.orange);
...
//		});
		...
		ImageIcon imageCaffe1 = new ImageIcon("src/cafeimg/adeimg/lemon.jpg");
		...
		ImageIcon imageCaffe2 = new ImageIcon("src/cafeimg/adeimg/bluelemon.jpg");
		...
		ImageIcon imageCaffe3 = new ImageIcon("src/cafeimg/adeimg/jamong.jpg");
		...
		ImageIcon imageCaffe4 = new ImageIcon("src/cafeimg/adeimg/grape.jpg");
		...
		JLabel jl1_Name = new JLabel("레몬에이드");
		...
		JLabel jl2_Name = new JLabel("블루 레몬에이드");
		...
		JLabel jl3_Name = new JLabel("자몽에이드");
		...
		JLabel jl4_Name = new JLabel("청포도 에이드");
		jl4_Name.setBounds(0, 150, 200, 20);
		jl4_Name.setHorizontalAlignment(JLabel.CENTER);
		
		jl1.addMouseListener(new AdeMouse(0, f, list));
		jl2.addMouseListener(new AdeMouse(1, f, list));
		jl3.addMouseListener(new AdeMouse(2, f, list));
		jl4.addMouseListener(new AdeMouse(3, f, list));
